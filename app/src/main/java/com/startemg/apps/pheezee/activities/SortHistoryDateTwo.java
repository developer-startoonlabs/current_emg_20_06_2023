...
public class SortHistoryDateTwo extends AppCompatActivity {
...
//        ViewPopUpWindow popUpWindow = new ViewPopUpWindow((Activity) context, patient, json_phizioemail);
            ...
            public void onFinish() {
                ...
                start_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent start_btn = new Intent(SortHistoryDateTwo.this, PatientsView.class);
                ...
                btn_history.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent history = new Intent(SortHistoryDateTwo.this, SortHistroyMonth.class);
                ...
                iv_back_app_info.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent back_press = new Intent(SortHistoryDateTwo.this, PhizioProfile.class);
...
//                MyAdapter myAdapter = new MyAdapter(SortHistoryDateTwo.this,car_name_arr,car_des_arr,car_id_arr,Imgurl);
                MyAdapterNew myAdapter = new MyAdapterNew(SortHistoryDateTwo.this,car_name_arr,car_des_arr,car_col_arr,car_id_arr,Imgurl);
