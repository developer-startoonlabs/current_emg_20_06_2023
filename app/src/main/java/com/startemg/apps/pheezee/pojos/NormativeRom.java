...
public class NormativeRom {String phizioemail;
    String patientid;
    ...
    String orientation;
    public NormativeRom(String phizioemail,String patientid, String patient_injured,String str_body_part,  String str_exercise_name, String str_muscle_name, String orientation ){
