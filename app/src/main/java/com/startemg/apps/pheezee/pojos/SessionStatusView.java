...
public class SessionStatusView {
    ...
    public SessionStatusView(String phizioemail, String patientid, String status) {
        this.phizioemail = phizioemail;
        this.patientid = patientid;
        this.status = status;
    }

    public SessionStatusView(String phizioemail, String patientid, String status, String date) {
        this.phizioemail = phizioemail;
        this.patientid = patientid;
        this.status = status;
        this.date = date;
